...
import com.point.enums.ModelTypeEnum;
import com.point.exception.MetaException;
...
public class MetaValidator {
    ...
    public static void validAndFillMetaRoot(Meta meta) {
        ...
        String description = StrUtil.emptyToDefault(meta.getDescription(), "模板代码生成器");
        String author = StrUtil.emptyToDefault(meta.getAuthor(), "point");
    ...
    public static void validAndFillFileConfig(Meta meta) {
        ...
        String defaultOutputRootPath = ".temp";
