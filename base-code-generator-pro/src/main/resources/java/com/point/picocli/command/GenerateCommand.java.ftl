...
public class GenerateCommand implements Callable<Integer> {
    ...
    public Integer call() throws Exception {
        ...
        String fromFile = System.getProperty("user.dir") + File.separator + "src/main/resources/templates/NiuKeWangPro/Main.java.ftl.ftl";
        String toFile = toDir + "/nkw-demo/src/main/java/com/point/Main.java.ftl";
