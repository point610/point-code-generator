...
import com.point.springbootinit.config.ImgBBClientConfig;
...
import com.point.springbootinit.utils.imgbb.ImgBBUtils;
...
public class ImgController {
     ...
     */
    @PostMapping("/upload")
    public BaseResponse<String> uploadImg(@RequestPart("img") MultipartFile multipartFile, UploadFileRequest uploadFileRequest, HttpServletRequest request) {

        System.out.println(imgBBClientConfig.getApi());
        System.out.println(imgBBClientConfig.getApi());
        System.out.println(imgBBClientConfig.getApi());
        ...
        try {
            ...
            String filePath = ImgBBUtils.upload(file, imgBBClientConfig.getApi());
            // 返回可访问地址
